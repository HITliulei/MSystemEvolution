...
public class MDemandPredAlgoTest extends TestCase {
    ...
    public void testFeedNodeRequestCaches() {
        ...
        MDepRequestCacheBean bean1 = new MDepRequestCacheBean(
                svcDependency, "user-01", 0, MResponse.successResponse(), "node1", "test1", "callback"
        );
        beanList.add(bean1);
        ...
        MDepRequestCacheBean bean2 = new MDepRequestCacheBean(
                svcDependency1, "user-01", 0, MResponse.successResponse(), "node1", "test1", "callback"
        );
        beanList.add(bean2);
        ...
        MDepRequestCacheBean bean3 = new MDepRequestCacheBean(
                svcDependency2, "user-01", 1, MResponse.successResponse(), "node1", "test1", "callback"
        );
        beanList.add(bean3);
    ...
    public void testFormatDataOneNode() {
        ...
        svcDependency1.setSlaSet(slaSet1);
        MDepRequestCacheBean bean2 = new MDepRequestCacheBean(
                svcDependency1, "user-01", 4, MResponse.successResponse(), "node1", "test1", "callback"
        );
        beanList.add(bean2);
        ...
        svcDependency2.setSlaSet(slaSet2);
        MDepRequestCacheBean bean3 = new MDepRequestCacheBean(
                svcDependency2, "user-01", 7, MResponse.successResponse(), "node1", "test1", "callback"
        );
        beanList.add(bean3);
