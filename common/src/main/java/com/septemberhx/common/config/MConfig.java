...
public class MConfig {
    ...
    public final static String K8S_NAMESPACE = "kube-mv4ms";
    ...
    // -- privide
    public final static String MCENTER_PROVIDE = "/getServiceInfo";
    public final static String MCENTER_PROVIDE_GETALLSERVICENAME = "/getAllServiceName";
